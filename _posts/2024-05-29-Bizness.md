---
title: <span style="color:#2FF300">Bizness</span>
layout: single
excerpt: ""
header:
show_date: true
...
```
Vamos a explotarlo.
Voy a probar a ponerme a capturar el trafico icmp de la interfaz 0 y voy a probar a mandar una traza a ver si la recibimos.
...
Encontramos unos archivos .dat (archivos de datos que contienen info especifica de un programa/app).
...
En esta [página](https://gchq.github.io/CyberChef/) podemos hacer este replace de los caracteres, pasarlo de base64 y a hexa
